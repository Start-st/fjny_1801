 ...
 * Generated at: 2020-06-19 08:23:50 UTC
...
public final class item_002dedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<form id=\"itemEidtForm\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\tname=\"sellPoint\" class=\"easyui-textbox\" prompt=\"请输入文本\"\r\n");
      out.write("\t\t\t\t\tdata-options=\"required:true,validType:'length[3,610]'\"\r\n");
      out.write("\t\t\t\t\tstyle=\"height:70px\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form-item\">\r\n");
      out.write("\t\t\t\t<label for=\"\" class=\"label-top\">商品价格：</label> <input id=\"price\"\r\n");
      out.write("\t\t\t\t\tname=\"price\" class=\"easyui-numberbox\" data-options=\"min:0\" />\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<div class=\"form-item\">\r\n");
      out.write("\t\t\t\t<label for=\"\" class=\"label-top\">库存数量：</label> <input id=\"price\"\r\n");
      out.write("\t\t\t\t\tname=\"num\" class=\"easyui-numberbox\" data-options=\"min:0\" />\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<div class=\"form-item\">\r\n");
      out.write("\t\t\t\t<label for=\"\" class=\"label-top\">条形码：</label> <input id=\"price\"\r\n");
      out.write("\t\t\t\t\tname=\"barcode\" class=\"easyui-numberbox\" value=\"100\"\r\n");
      out.write("\t\t\t\t\tdata-options=\"required:true\" />\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<div class=\"form-item\">\r\n");
      ...
      out.write("\t\t $(function() {\r\n");
      out.write("\t\t//创建富文本编辑器 \r\n");
      out.write("\t\titemEditEditor = TT.createEditor(\"#itemEidtForm [name=desc]\"); \r\n");
      out.write("\t\t//初始化类目选择和图片上传器 \r\n");
      out.write("\t\tTT.init({ \r\n");
      out.write("\t\t\tfun : function(node) {\r\n");
      out.write("\t\t\t//根据商品的分类id取商品 的规格模板，生成规格信息。第四天内容。\r\n");
      out.write("\t\t\t\tTT.changeItemParam(node, \"itemEidtForm\"); \r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t}); \r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\t//提交表单\r\n");
      ...
      out.write("\t\t\t\t//有效性验证\r\n");
      out.write("\t\t\t\tif (!$('#itemEidtForm').form('validate')) {\r\n");
      out.write("\t\t\t\t\t$.messager.alert('提示', '表单还未填写完成!');\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\titemEditEditor.sync();\r\n");
      out.write("\t\t\t\t//ajax的post方式提交表单\r\n");
      out.write("\t\t\t\t//$(\"#itemEidtForm\").serialize()将表单序列号为key - value形式的字符串\r\n");
      out.write("\t\t\t\talert($(\"#itemEidtForm\").serialize());\r\n");
      out.write("\t\t\t\t$.post(\"/item/update\", $(\"#itemEidtForm\").serialize(), function(\r\n");
      out.write("\t\t\t\t\t\tdata) {\r\n");
      out.write("\t\t\t\t\tif (data.status == 200) {\r\n");
      out.write("\t\t\t\t\t\t$(\"#dgTbItem\").datagrid(\"reload\");\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert('操作成功', '恭喜您添加产品成功', 'warning',\r\n");
      out.write("\t\t\t\t\t\t\t\tfunction() {\r\n");
      ...
      out.write("\t\t\t\t$('#itemEidtForm').form('reset');\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t</script>\r\n");
      out.write("\t</div>");
